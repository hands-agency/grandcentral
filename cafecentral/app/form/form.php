...
/**
 * Change la méthode de requête du formulaire (get ou post)
 * 
 * @param	string	get ou post (post par défaut)
 * @access	public
 */
	public function set_method($method)
	{
		$method = (in_array($method, array('post', 'get'))) ? $method : 'post';
...
/**
 * Change le thème du formulaire (thème "default" par défaut)
 * 
 ...
 */
	...
	{
		$html = new html($this, $this->theme, $this->template);
