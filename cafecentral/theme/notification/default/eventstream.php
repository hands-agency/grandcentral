...
/********************************************************************************************/
//	css
	$_VIEW->bind('css', '/css/eventstream.css');
//	script
	$_VIEW->bind('script', '/js/eventstream.js');
...
/********************************************************************************************/
	...
	//	Bind script
		...
		$.sse({
			...
			//	Add the new line
				li = '<li data-item=\"'+item+'\" style=\"display:none;opacity:'+data['opacity']+'\"><a href=\"'+data['editauthor']+'\">'+data['author']+'</a> '+data['event']+' <a href=\"'+data['edit']+'\">'+data['title']+'</a> • <a href=\"\" class=\"undo\">Undo</a> • <a href=\"\" class=\"compare\">What\'s new?</a></li>';
