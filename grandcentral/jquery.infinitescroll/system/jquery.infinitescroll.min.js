...
//	Here we go!
	...
	//	The "constructor"
		...
		//	Store the wants more so we can detroy it
		...
		//	Bind autoscroll
			if (plugin.settings.autoscroll === true)
			{
				...
				{
					$('.infiniteScrollWantsMore:not(.loading):in-viewport').trigger('click');
				});
			};
	...
	//	Load content
		...
		{
			console.log('load');
		//	Unbind the autoscroll to prevent chain load
