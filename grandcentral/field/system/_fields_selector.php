 ...
 * @abstract
 */
abstract class _fields_selector extends _fields
{
 ...
 */
	public function set_value($value)
	{
		...
		{
			$value = $value->get_table().'_'.$value['id'];
		}
 ...
 * @access	public
 */
	// public function set_irel($value)
	// {
	// 	$this->irel = $value;
	// 	return $this;
	// }
 ...
 */
	public function prepare_values()
	{
		...
		// if ((is_array($values) && count(array_filter(array_keys($values),'is_string')) != count($values)))
		// 	{
