...
(5, 'user', 'User', '', 1, '{"id":{"key":"id","type":"id","title":"The unique identifier"},"key":{"key":"key","type":"key","title":"The key"},"title":{"key":"title","type":"string","title":"A short title","min":"0","max":"255","required":"1"},"password":{"key":"password","type":"password","title":"Password","min":"","max":"60"},"created":{"key":"created","type":"created","title":"Created Datetime"},"updated":{"key":"updated","type":"updated","title":"Updated Datetime"},"status":{"key":"status","type":"status"}}', 0, '2013-09-25 09:16:34', '2013-09-25 09:16:34', 'live');
...
INSERT INTO `user` (`id`, `key`, `title`, `password`, `created`, `updated`, `status`) VALUES
(1, 'anonymous', 'Anonymous User', '', '2013-09-25 12:29:16', '2013-09-25 12:29:53', 'live'),
(2, 'mvd@cafecentral.fr', 'Michaël V. Dandrieux', '$2a$12$nqK/dVP4XrzwWUP5iXi6MOq2xEL7ujnF.UCdrD0s8jOLRVPE3ZdYu', '0000-00-00 00:00:00', '2013-09-19 15:57:18', 'live'),
(3, 'sf@cafecentral.fr', 'Sylvain Frigui', '', '0000-00-00 00:00:00', '2013-09-19 16:03:09', 'live');
